...
while (<IN>){
    ...
    print "mkdir mydata\n";
    print "cd mydata\n";
    print "mkdir chromat_dir phd_dir edit_dir poly_dir\n";
    ...
    print "cp ../*.scf chromat_dir\n";
    print "cd edit_dir\n";
    print "phred -id ../chromat_dir/ -pd ../phd_dir/ -dd ../poly_dir\n";
    ...
    print "polyphred -ace $_.fa.ace -ms off -score $polyphredscore -quality $polyphredquality -o $_.polyphred.out\n";
    print "cd ../../../\n\n\n";
}
