...
while (<IN>){
    ...
    print "cd mydata\n";
    print "cd aln_final\n";
    print "perl ~/SeqQual/replace-$replace-nucleotide_aln.pl\n";
    print "mv aln_replace$replace ..\n";
    print "cd ..\n";
    print "mv aln_final aln_before-replace\n";
    print "mv aln_replace$replace aln_final\n";
    print "cd ../../\n\n\n";
}
