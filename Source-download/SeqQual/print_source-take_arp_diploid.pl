...
while (<IN>){
    ...
    print "echo --------------------------------------------------\n";
    print "cd mydata\n";
    print "cd arlequin_input0\n";
    print "perl ~/SeqQual/take_arp_to_output_diploid.pl\n";
    print "cd ../arlequin_input1\n";
    print "perl ~/SeqQual/take_arp_to_output_diploid.pl\n";
    print "cd ../../../\n\n\n";
}
print "cd Output/arlequin\n";
print "ls *.arp > all.arb\n";
print "ls *.hap.arp > all-hap.arb\n";
print "ls *.dip.arp > all-dip.arb\n";
print "cd ../../\n";
