...
echo Processing fasta alignments from validated diploid data routine.
...
#mkdir aln_haplotype  # needed if alignment with deduced alleles organised in haplotypes BUT phase unknown wanted
...
echo ======================================================================
     # "inputfile" is the txt file containing the sub-folder or list of subfolder where the fasta alignments
     # are located. There is no need for a multi-subdirectory structure here as the fasta alignments
     # names will be conserved with a suffix corresponding to each treatment below
     # all "inputfile" parameters which follow will allow to read the same list of subfolders
...
#perl ~/SeqQual/print_log-replace.pl 3 >> log.txt
 ...
 #echo ======================================================================
      # parameter value after "inputfile" means that columns or bases in alignments 
...
#perl ~/SeqQual/print_log-write_haplotypealn.pl >> log.txt
 ...
 echo ======================================================================
    # In order to produce an input file for the Arlequin program with a population structure, the chain of character 'qp qr'
    # after "inputfile" below needs to be edited with a chain of character corresponding 
...
perl ~/SeqQual/print_source-arlequin-diploid.pl inputfile qp qr > source-write_arlequin.txt
source source-write_arlequin.txt
 echo ======================================================================
 echo Take diploid arlequin input files into directory Output/arlequin.
 echo ======================================================================
perl ~/SeqQual/print_source-take_arp_diploid.pl inputfile > source-take_arp_haploid.txt
...
perl ~/SeqQual/print_log-arlequin-diploid.pl qp qr >> log.txt
