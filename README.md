...
<b>Details</b> for each script can be found <A HREF= "SeqQual_pdf/"> here</A> for <b>tasks 1),</b>  <A HREF= "SeqQual_pdf/"> here</A> for <b>tasks 2),</b>  <A HREF= "SeqQual_pdf/"> here</A> for <b>tasks 3)</b>. For several scripts, log files can be printed from associated  "print_log*.pl" scripts described <A HREF= "SeqQual_pdf/"> here</A>.
